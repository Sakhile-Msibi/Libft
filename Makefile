...
SRCS = ft_bzero.c ft_isalpha.c ft_isalnum.c ft_isascii.c \
	  ...
	  ft_strcat.c ft_strchr.c ft_strcmp.c ft_strcpy.c ft_numlen_max.c \
	  ...
	  ft_itoa_base_max.c ft_memalloc.c ft_memdel.c ft_strnew.c ft_strdel.c \
...
OBJS = ft_bzero.o ft_isalpha.o ft_isalnum.o ft_isascii.o \
	  ...
	  ft_strcat.o ft_strchr.o ft_strcmp.o ft_strcpy.o ft_numlen_max.o \
	  ...
	  ft_itoa_base_max.o ft_memalloc.o ft_memdel.o ft_strnew.o ft_strdel.o \
	  ft_strclr.o  ft_striter.o ft_striteri.o ft_strmap.o \
	  ft_strmapi.o ft_strequ.o ft_strnequ.o ft_strsub.o \
	  ft_strjoin.o ft_strjoin_mod.o ft_strjoinfree.o ft_strtrim.o \
	  ft_strsplit.o ft_putendl.o ft_putchar_fd.o ft_putstr_fd.o \
	  ft_putendl_fd.o ft_putnbr_fd.o ft_lstnew.o ft_lstadd.o get_next_line.o
