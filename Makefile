...
SRCS = ft_bzero.c ft_isalpha.c ft_isalnum.c ft_isascii.c \
	  ...
	  ft_strncmp.c ft_strncpy.c ft_strrchr.c ft_atoi.c \
	  ft_strstr.c ft_tolower.c ft_toupper.c  ft_strnstr.c\
	  ft_putchar.c ft_putstr.c ft_putnbr.c ft_itoa.c \
	  ...
	  ft_strjoin.c ft_strtrim.c ft_strsplit.c ft_putendl.c \
...
OBJS = ft_bzero.o ft_isalpha.o ft_isalnum.o ft_isascii.o \
	  ...
	  ft_strncmp.o ft_strncpy.o ft_strrchr.o ft_atoi.o \
	  ft_strstr.o ft_tolower.o ft_toupper.o  ft_strnstr.o\
